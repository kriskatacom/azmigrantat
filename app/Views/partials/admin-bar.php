        ...
        <div class="admin-bar-scroll overflow-x-auto flex items-center h-full">
            <div class="container mx-auto flex items-center justify-between px-4 min-w-max gap-8">
                ...
                <div class="flex items-center gap-6 shrink-0 h-full">
                    ...
                    <a href="/admin/media" class="flex items-center gap-2 group whitespace-nowrap transition-colors
                                                 text-slate-500 hover:text-slate-900 
                                                 dark:text-gray-400 dark:hover:text-white">
                ...
                <div class="flex items-center gap-6 shrink-0 h-full">
                    ...
                    <div class="hidden lg:flex items-center gap-2 text-[10px] font-bold px-2 py-0.5 rounded border whitespace-nowrap
                                text-emerald-600 bg-emerald-50 border-emerald-100
                                dark:text-emerald-500 dark:bg-emerald-500/10 dark:border-emerald-500/20">
                    ...
                    <div class="flex items-center gap-6 border-l border-gray-100 dark:border-slate-800 pl-6 h-full">
                        ...
                        <form action="/users/logout" method="POST" class="m-0 flex items-center h-full">
                            <button type="submit" class="group flex items-center gap-2 text-xs px-4 py-1.5 rounded-md uppercase font-bold transition-all duration-300 border
                                                       ...
                                                       dark:bg-red-500/10 dark:text-red-400 dark:border-red-500/20 dark:hover:bg-red-500 dark:hover:text-white">
                                <span>Изход</span>
