...
define('AUTH_PUBLIC_SERVER_URL', $_ENV['AUTH_PUBLIC_SERVER_URL'] ?? AUTH_SERVER_URL);
define('BUSINESS_PUBLIC_WEBSITE_SERVER_URL', $_ENV['BUSINESS_PUBLIC_WEBSITE_SERVER_URL'] ?? BUSINESS_WEBSITE_SERVER_URL);
