    ...
    <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1);">
        ...
        <div style="padding: 40px;">
            <div style="margin-bottom: 30px;">
                <p style="text-transform: uppercase; font-size: 11px; font-weight: 800; tracking: 0.1em; color: #64748b; margin-bottom: 8px;">Детайли на подателя</p>
            ...
            <div style="margin-bottom: 30px;">
                <p style="text-transform: uppercase; font-size: 11px; font-weight: 800; tracking: 0.1em; color: #64748b; margin-bottom: 8px;">Съобщение</p>
