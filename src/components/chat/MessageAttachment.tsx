...
export default function MessageAttachment({ message, isMe, colors }: MessageAttachmentProps) {
  ...
  if (isImage) {
    return (
      <TouchableOpacity accessibilityRole="imagebutton" accessibilityLabel={`Отвори ${attachment.name}`} activeOpacity={0.9} onPress={() => void WebBrowser.openBrowserAsync(attachment.url)}>
