            ...
            <div className="container mx-auto grid xl:grid-cols-2 lg:gap-10">
                <div className="grid gap-5 p-5 md:py-10">
                    ...
                    >
                        ...
                        <span className="font-semibold">{t("contact.centralOffice")}:</span>
                        +359 96593 333
                    </a>
                    ...
                    >
                        ...
                        <span className="font-semibold">
                            {t("contact.servicesAndInquiries")}
                        </span>
                        +359 884 833 352
                    </a>
                    ...
                    >
                        ...
                        <span className="font-semibold">
                            {t("contact.flightTicketsAndFinancing")}
                        </span>
                        +359 88 840 3353
                    </a>
                    ...
                    >
                        ...
                        <span className="font-semibold">
                            {t("contact.insuranceAndLegalization")}
                        </span>
                        +359 884 833 351
                    </a>
                    ...
                    >
                        ...
                        {t("contact.montanaOfficeAddress")}
                    </a>
                </div>
                <div className="flex flex-col justify-center items-center gap-5 p-5 ">
                    <h2 className="text-white text-2xl font-semibold">
                        {t("contact.findUsInSocial")}
                    </h2>
                    <a
