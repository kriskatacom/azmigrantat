...
export default function NewTrainForm({ train, countries }: Params) {
    ...
    const [formData, setFormData] = useState<NewTrain>({
        ...
        name: train?.name ?? "",
        slug: train?.slug ?? "",
        website_url: train?.website_url ?? "",
        country_id: train?.country_id ?? null,
        city_id: train?.city_id ?? null,
    });
