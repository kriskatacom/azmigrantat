...
export default function BulgariaCitiesMap() {
    return (
        <div className="bulgaria-cities-map svg-container max-w-7xl mx-auto">
            <svg
            ...
            >
                <a href="/bulgaria/cities/blagoevgrad">
                    <path
                        ...
                        id="BG-01"
                    ></path>
                    <text x="72" y="332" fontSize="12" fill="white">
                        Благоевград
                    </text>
                </a>
                <a href="/bulgaria/cities/burgas">
                    <path
                        ...
                        id="BG-02"
                    ></path>
                    <text x="455" y="230" fontSize="12" fill="white">
                        Бургас
                    </text>
                </a>
                <a href="/bulgaria/cities/varna">
                    <path
                        ...
                        id="BG-03"
                    ></path>
                    <text x="493" y="145" fontSize="12" fill="white">
                        Варна
                    </text>
                </a>
                <a
                    href="/bulgaria/veliko-tarnovo"
                >
                    <path
                        ...
                        id="BG-04"
                    ></path>
                    <text x="290" y="140" fontSize="12" fill="white">
                        В. Търново
                    </text>
                </a>
                <a href="/bulgaria/cities/vidin">
                    <path
                ...
                <a href="/bulgaria/cities/vratsa">
                    <path
                        ...
                        id="BG-06"
                    ></path>
                    <text x="120" y="112" fontSize="12" fill="white">
                        Враца
                    </text>
                </a>
                <a href="/bulgaria/cities/gabrovo">
                    <path
                        ...
                        id="BG-07"
                    ></path>
                    <text x="260" y="175" fontSize="12" fill="white">
                        Габрово
                    </text>
                </a>
                <a href="/bulgaria/cities/dobrich">
                    <path
                        ...
                        id="BG-08"
                    ></path>
                    <text x="520" y="80" fontSize="12" fill="white">
                        Добрич
                    </text>
                </a>
                <a href="/bulgaria/cities/kardzhali">
                    <path
                        ...
                        id="BG-09"
                    ></path>
                    <text x="270" y="360" fontSize="12" fill="white">
                        Кърджали
                    </text>
                </a>
                <a href="/bulgaria/cities/kyustendil">
                    <path
                        ...
                        id="BG-10"
                    ></path>
                    <text x="25" y="270" fontSize="12" fill="white">
                        Кюстендил
                    </text>
                </a>
                <a href="/bulgaria/cities/lovech">
                    <path
                        ...
                        id="BG-11"
                    ></path>
                    <text x="195" y="165" fontSize="12" fill="white">
                        Ловеч
                    </text>
                </a>
                <a href="/bulgaria/cities/montana">
                    <path
                        ...
                        id="BG-12"
                    ></path>
                    <text x="55" y="95" fontSize="12" fill="white">
                        Монтана
                    </text>
                </a>
                <a href="/bulgaria/cities/pazardzhik">
                    <path
                        ...
                        id="BG-13"
                    ></path>
                    <text x="142" y="280" fontSize="12" fill="white">
                        Пазарджик
                    </text>
                </a>
                <a href="/bulgaria/cities/pernik">
                    <path
                        ...
                        id="BG-14"
                    ></path>
                    <text x="32" y="220" fontSize="12" fill="white">
                        Перник
                    </text>
                </a>
                <a href="/bulgaria/cities/pleven">
                    <path
                        ...
                        id="BG-15"
                    ></path>
                    <text x="210" y="100" fontSize="12" fill="white">
                        Плевен
                    </text>
                </a>
                <a href="/bulgaria/cities/plovdiv">
                    <path
                        ...
                        id="BG-16"
                    ></path>
                    <text x="213" y="260" fontSize="12" fill="white">
                        Пловдив
                    </text>
                </a>
                <a href="/bulgaria/cities/razgrad">
                    <path
                        ...
                        id="BG-17"
                    ></path>
                    <text x="390" y="90" fontSize="12" fill="white">
                        Разград
                    </text>
                </a>
                <a href="/bulgaria/cities/ruse">
                    <path
                        ...
                        id="BG-18"
                    ></path>
                    <text x="345" y="73" fontSize="12" fill="white">
                        Русе
                    </text>
                </a>
                <a href="/bulgaria/cities/silistra">
                    <path
                        ...
                        id="BG-19"
                    ></path>
                    <text x="430" y="40" fontSize="12" fill="white">
                        Силистра
                    </text>
                </a>
                <a href="/bulgaria/cities/sliven">
                    <path
                        ...
                        id="BG-20"
                    ></path>
                    <text x="355" y="210" fontSize="12" fill="white">
                        Сливен
                    </text>
                </a>
                <a href="/bulgaria/cities/smolyan">
                    <path
                        ...
                        id="BG-21"
                    ></path>
                    <text x="195" y="349" fontSize="12" fill="white">
                        Смолян
                    </text>
                </a>
                <a
                    href="/bulgaria/sofia-state"
                >
                    <path
                        ...
                        id="BG-22"
                    ></path>
                    <text x="125" y="205" fontSize="10" fill="white">
                        София-област
                    </text>
                </a>
                <a href="/bulgaria/cities/sofia">
                    <path
                        ...
                        id="BG-23"
                    ></path>
                    <text x="80" y="210" fontSize="10" fill="white">
                        София
                    </text>
                </a>
                <a
                    href="/bulgaria/stara-zagora"
                >
                    <path
                        ...
                        id="BG-24"
                    ></path>
                    <text x="280" y="240" fontSize="10" fill="white">
                        Стара Загора
                    </text>
                </a>
                <a href="/bulgaria/cities/targovishte">
                    <path
                        ...
                        id="BG-25"
                    ></path>
                    <text x="370" y="140" fontSize="10" fill="white">
                        Търговище
                    </text>
                </a>
                <a href="/bulgaria/cities/haskovo">
                    <path
                        ...
                        id="BG-26"
                    ></path>
                    <text x="325" y="315" fontSize="12" fill="white">
                        Хасково
                    </text>
                </a>
                <a href="/bulgaria/cities/yambol">
                    <path
                        ...
                        id="BG-28"
                    ></path>
                    <text x="395" y="260" fontSize="12" fill="white">
                        Ямбол
                    </text>
                </a>
                <a href="/bulgaria/cities/shumen">
                    <path
                        ...
                        id="BG-27"
                    ></path>
                    <text x="435" y="125" fontSize="12" fill="white">
                        Шумен
                    </text>
                </a>
            </svg>
